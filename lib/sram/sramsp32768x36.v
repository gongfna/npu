...
//       
//       Creation Date:  Fri Jul 13 09:51:13 2018
//       Version: 	r1p2
//
...
module datapath_latch_sramsp32768x36 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_sramsp32768x36
...
`ifdef POWER_PINS
module sramsp32768x36 (VDDCE, VDDPE, VSSE, CENY, WENY, AY, GWENY, Q, SO, CLK, CEN,
    WEN, A, D, EMA, EMAW, TEN, TCEN, TWEN, TA, TD, GWEN, TGWEN, RET1N, SI, SE, DFTRAMBYP);
`else
module sramsp32768x36 (CENY, WENY, AY, GWENY, Q, SO, CLK, CEN, WEN, A, D, EMA, EMAW,
...
`endif
  ...
  parameter MUX = 32;
  parameter MEM_WIDTH = 1152; // redun block size 8, 576 on left, 576 on right
...
`endif
  ...
  integer row_address;
  integer mux_address;
  reg [1151:0] mem [0:1023];
  reg [1151:0] row, row_t;
  reg LAST_CLK;
  reg [1151:0] row_mask;
  reg [1151:0] new_data;
  reg [1151:0] data_out;
 ...
 wire  CLK_;
  ...
  assign `ARM_UD_DP WENY_ = (RET1N_ | pre_charge_st) ? ({36{DFTRAMBYP_}} & (TEN_ ? WEN_ : TWEN_)) : {36{1'bx}};
  ...
  assign `ARM_UD_SEQ Q_ = (RET1N_ | pre_charge_st) ? ((Q_int)) : {36{1'bx}};
  assign `ARM_UD_DP SO_ = (RET1N_ | pre_charge_st) ? ({Q_[18], Q_[17]}) : {2{1'bx}};
    ...
    if (GWEN_int !== 1'b1 && DFTRAMBYP_int=== 1'b0 && SE_int === 1'bx) begin
      ...
      if( (isBitX(GWEN_int) && DFTRAMBYP_int!==1) || isBitX(DFTRAMBYP_int) ) begin
        ...
        D_int = {36{1'bx}};
          ...
          writeEnable = ~ ( {36{GWEN_int}} | {WEN_int[35], WEN_int[34], WEN_int[33],
          WEN_int[32], WEN_int[31], WEN_int[30], WEN_int[29], WEN_int[28], WEN_int[27],
          WEN_int[26], WEN_int[25], WEN_int[24], WEN_int[23], WEN_int[22], WEN_int[21],
          WEN_int[20], WEN_int[19], WEN_int[18], WEN_int[17], WEN_int[16], WEN_int[15],
          WEN_int[14], WEN_int[13], WEN_int[12], WEN_int[11], WEN_int[10], WEN_int[9],
          WEN_int[8], WEN_int[7], WEN_int[6], WEN_int[5], WEN_int[4], WEN_int[3], WEN_int[2],
          WEN_int[1], WEN_int[0]});
      if (GWEN_int !== 1'b1 || DFTRAMBYP_int === 1'b1 || DFTRAMBYP_int === 1'bx) begin
        row_mask =  ( {31'b0000000000000000000000000000000, writeEnable[35], 31'b0000000000000000000000000000000, writeEnable[34],
          31'b0000000000000000000000000000000, writeEnable[33], 31'b0000000000000000000000000000000, writeEnable[32],
          31'b0000000000000000000000000000000, writeEnable[31], 31'b0000000000000000000000000000000, writeEnable[30],
        ...
        new_data =  ( {31'b0000000000000000000000000000000, D_int[35], 31'b0000000000000000000000000000000, D_int[34],
          31'b0000000000000000000000000000000, D_int[33], 31'b0000000000000000000000000000000, D_int[32],
          31'b0000000000000000000000000000000, D_int[31], 31'b0000000000000000000000000000000, D_int[30],
        ...
        readLatch0 = {data_out[1144], data_out[1136], data_out[1128], data_out[1120],
          data_out[1112], data_out[1104], data_out[1096], data_out[1088], data_out[1080],
          data_out[1072], data_out[1064], data_out[1056], data_out[1048], data_out[1040],
          data_out[1032], data_out[1024], data_out[1016], data_out[1008], data_out[1000],
          data_out[992], data_out[984], data_out[976], data_out[968], data_out[960],
          data_out[952], data_out[944], data_out[936], data_out[928], data_out[920],
          data_out[912], data_out[904], data_out[896], data_out[888], data_out[880],
          data_out[872], data_out[864], data_out[856], data_out[848], data_out[840],
          data_out[832], data_out[824], data_out[816], data_out[808], data_out[800],
          data_out[792], data_out[784], data_out[776], data_out[768], data_out[760],
          data_out[752], data_out[744], data_out[736], data_out[728], data_out[720],
          data_out[712], data_out[704], data_out[696], data_out[688], data_out[680],
          data_out[672], data_out[664], data_out[656], data_out[648], data_out[640],
          data_out[632], data_out[624], data_out[616], data_out[608], data_out[600],
          data_out[592], data_out[584], data_out[576], data_out[568], data_out[560],
          data_out[552], data_out[544], data_out[536], data_out[528], data_out[520],
          data_out[512], data_out[504], data_out[496], data_out[488], data_out[480],
          data_out[472], data_out[464], data_out[456], data_out[448], data_out[440],
          data_out[432], data_out[424], data_out[416], data_out[408], data_out[400],
          data_out[392], data_out[384], data_out[376], data_out[368], data_out[360],
          data_out[352], data_out[344], data_out[336], data_out[328], data_out[320],
          data_out[312], data_out[304], data_out[296], data_out[288], data_out[280],
      ...
      if (GWEN_int !== 1'b1 || DFTRAMBYP_int === 1'b1) begin
        ...
        mem_path = {shifted_readLatch0[140], shifted_readLatch0[136], shifted_readLatch0[132],
          ...
          shifted_readLatch0[104], shifted_readLatch0[100], shifted_readLatch0[96],
          shifted_readLatch0[92], shifted_readLatch0[88], shifted_readLatch0[84], shifted_readLatch0[80],
          shifted_readLatch0[76], shifted_readLatch0[72], shifted_readLatch0[68], shifted_readLatch0[64],
          shifted_readLatch0[60], shifted_readLatch0[56], shifted_readLatch0[52], shifted_readLatch0[48],
          shifted_readLatch0[44], shifted_readLatch0[40], shifted_readLatch0[36], shifted_readLatch0[32],
          shifted_readLatch0[28], shifted_readLatch0[24], shifted_readLatch0[20], shifted_readLatch0[16],
          shifted_readLatch0[12], shifted_readLatch0[8], shifted_readLatch0[4], shifted_readLatch0[0]};
...
`endif
  ...
  datapath_latch_sramsp32768x36 uDQ0 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[0]), .D(D_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[0]), .XQ(XQ), .Q(Q_int[0]));
  datapath_latch_sramsp32768x36 uDQ1 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[0]), .D(D_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[1]), .XQ(XQ), .Q(Q_int[1]));
  datapath_latch_sramsp32768x36 uDQ2 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[1]), .D(D_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[2]), .XQ(XQ), .Q(Q_int[2]));
  datapath_latch_sramsp32768x36 uDQ3 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[2]), .D(D_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[3]), .XQ(XQ), .Q(Q_int[3]));
  datapath_latch_sramsp32768x36 uDQ4 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[3]), .D(D_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[4]), .XQ(XQ), .Q(Q_int[4]));
  datapath_latch_sramsp32768x36 uDQ5 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[4]), .D(D_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[5]), .XQ(XQ), .Q(Q_int[5]));
  datapath_latch_sramsp32768x36 uDQ6 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[5]), .D(D_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[6]), .XQ(XQ), .Q(Q_int[6]));
  datapath_latch_sramsp32768x36 uDQ7 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[6]), .D(D_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[7]), .XQ(XQ), .Q(Q_int[7]));
  datapath_latch_sramsp32768x36 uDQ8 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[7]), .D(D_int_bmux[8]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[8]), .XQ(XQ), .Q(Q_int[8]));
  datapath_latch_sramsp32768x36 uDQ9 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[8]), .D(D_int_bmux[9]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[9]), .XQ(XQ), .Q(Q_int[9]));
  datapath_latch_sramsp32768x36 uDQ10 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[9]), .D(D_int_bmux[10]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[10]), .XQ(XQ), .Q(Q_int[10]));
  datapath_latch_sramsp32768x36 uDQ11 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[10]), .D(D_int_bmux[11]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[11]), .XQ(XQ), .Q(Q_int[11]));
  datapath_latch_sramsp32768x36 uDQ12 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[11]), .D(D_int_bmux[12]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[12]), .XQ(XQ), .Q(Q_int[12]));
  datapath_latch_sramsp32768x36 uDQ13 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[12]), .D(D_int_bmux[13]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[13]), .XQ(XQ), .Q(Q_int[13]));
  datapath_latch_sramsp32768x36 uDQ14 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[13]), .D(D_int_bmux[14]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[14]), .XQ(XQ), .Q(Q_int[14]));
  datapath_latch_sramsp32768x36 uDQ15 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[14]), .D(D_int_bmux[15]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[15]), .XQ(XQ), .Q(Q_int[15]));
  datapath_latch_sramsp32768x36 uDQ16 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[15]), .D(D_int_bmux[16]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[16]), .XQ(XQ), .Q(Q_int[16]));
  datapath_latch_sramsp32768x36 uDQ17 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[16]), .D(D_int_bmux[17]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[17]), .XQ(XQ), .Q(Q_int[17]));
  datapath_latch_sramsp32768x36 uDQ18 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[19]), .D(D_int_bmux[18]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[18]), .XQ(XQ), .Q(Q_int[18]));
  datapath_latch_sramsp32768x36 uDQ19 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[20]), .D(D_int_bmux[19]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[19]), .XQ(XQ), .Q(Q_int[19]));
  datapath_latch_sramsp32768x36 uDQ20 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[21]), .D(D_int_bmux[20]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[20]), .XQ(XQ), .Q(Q_int[20]));
  datapath_latch_sramsp32768x36 uDQ21 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[22]), .D(D_int_bmux[21]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[21]), .XQ(XQ), .Q(Q_int[21]));
  datapath_latch_sramsp32768x36 uDQ22 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[23]), .D(D_int_bmux[22]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[22]), .XQ(XQ), .Q(Q_int[22]));
  datapath_latch_sramsp32768x36 uDQ23 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[24]), .D(D_int_bmux[23]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[23]), .XQ(XQ), .Q(Q_int[23]));
  datapath_latch_sramsp32768x36 uDQ24 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[25]), .D(D_int_bmux[24]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[24]), .XQ(XQ), .Q(Q_int[24]));
  datapath_latch_sramsp32768x36 uDQ25 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[26]), .D(D_int_bmux[25]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[25]), .XQ(XQ), .Q(Q_int[25]));
  datapath_latch_sramsp32768x36 uDQ26 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[27]), .D(D_int_bmux[26]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[26]), .XQ(XQ), .Q(Q_int[26]));
  datapath_latch_sramsp32768x36 uDQ27 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[28]), .D(D_int_bmux[27]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[27]), .XQ(XQ), .Q(Q_int[27]));
  datapath_latch_sramsp32768x36 uDQ28 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[29]), .D(D_int_bmux[28]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[28]), .XQ(XQ), .Q(Q_int[28]));
  datapath_latch_sramsp32768x36 uDQ29 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[30]), .D(D_int_bmux[29]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[29]), .XQ(XQ), .Q(Q_int[29]));
  datapath_latch_sramsp32768x36 uDQ30 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[31]), .D(D_int_bmux[30]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[30]), .XQ(XQ), .Q(Q_int[30]));
  datapath_latch_sramsp32768x36 uDQ31 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[32]), .D(D_int_bmux[31]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[31]), .XQ(XQ), .Q(Q_int[31]));
  datapath_latch_sramsp32768x36 uDQ32 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[33]), .D(D_int_bmux[32]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[32]), .XQ(XQ), .Q(Q_int[32]));
  datapath_latch_sramsp32768x36 uDQ33 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[34]), .D(D_int_bmux[33]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[33]), .XQ(XQ), .Q(Q_int[33]));
  datapath_latch_sramsp32768x36 uDQ34 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(Q_int[35]), .D(D_int_bmux[34]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[34]), .XQ(XQ), .Q(Q_int[34]));
  datapath_latch_sramsp32768x36 uDQ35 (.CLK(CLK), .Q_update(Q_update), .D_update(D_sh_update), .SE(SE_), .SI(SI_int[1]), .D(D_int_bmux[35]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path[35]), .XQ(XQ), .Q(Q_int[35]));
...
`endif
  ...
  reg NOT_CEN, NOT_WEN35, NOT_WEN34, NOT_WEN33, NOT_WEN32, NOT_WEN31, NOT_WEN30, NOT_WEN29;
  ...
  reg NOT_WEN6, NOT_WEN5, NOT_WEN4, NOT_WEN3, NOT_WEN2, NOT_WEN1, NOT_WEN0, NOT_A14;
  reg NOT_A13, NOT_A12, NOT_A11, NOT_A10, NOT_A9, NOT_A8, NOT_A7, NOT_A6, NOT_A5, NOT_A4;
  reg NOT_A3, NOT_A2, NOT_A1, NOT_A0, NOT_D35, NOT_D34, NOT_D33, NOT_D32, NOT_D31;
  ...
  reg NOT_TCEN, NOT_TWEN35, NOT_TWEN34, NOT_TWEN33, NOT_TWEN32, NOT_TWEN31, NOT_TWEN30;
  reg NOT_TWEN29, NOT_TWEN28, NOT_TWEN27, NOT_TWEN26, NOT_TWEN25, NOT_TWEN24, NOT_TWEN23;
  reg NOT_TWEN22, NOT_TWEN21, NOT_TWEN20, NOT_TWEN19, NOT_TWEN18, NOT_TWEN17, NOT_TWEN16;
  reg NOT_TWEN15, NOT_TWEN14, NOT_TWEN13, NOT_TWEN12, NOT_TWEN11, NOT_TWEN10, NOT_TWEN9;
  reg NOT_TWEN8, NOT_TWEN7, NOT_TWEN6, NOT_TWEN5, NOT_TWEN4, NOT_TWEN3, NOT_TWEN2;
  reg NOT_TWEN1, NOT_TWEN0, NOT_TA14, NOT_TA13, NOT_TA12, NOT_TA11, NOT_TA10, NOT_TA9;
  ...
  reg NOT_TD2, NOT_TD1, NOT_TD0, NOT_GWEN, NOT_TGWEN, NOT_SI1, NOT_SI0, NOT_SE, NOT_DFTRAMBYP;
  reg NOT_RET1N;
 ...
 wire  CLK_;
  ...
  buf B45(AY[8], AY_[8]);
  buf B46(AY[9], AY_[9]);
  buf B47(AY[10], AY_[10]);
  buf B48(AY[11], AY_[11]);
  buf B49(AY[12], AY_[12]);
  buf B50(AY[13], AY_[13]);
  buf B51(AY[14], AY_[14]);
  buf B52(GWENY, GWENY_);
  buf B53(Q[0], Q_[0]);
  buf B54(Q[1], Q_[1]);
  buf B55(Q[2], Q_[2]);
  buf B56(Q[3], Q_[3]);
  ...
  buf B91(CLK_, CLK);
  buf B92(CEN_, CEN);
  buf B93(WEN_[0], WEN[0]);
  buf B94(WEN_[1], WEN[1]);
  buf B95(WEN_[2], WEN[2]);
  buf B96(WEN_[3], WEN[3]);
  buf B97(WEN_[4], WEN[4]);
  buf B98(WEN_[5], WEN[5]);
  buf B99(WEN_[6], WEN[6]);
  buf B100(WEN_[7], WEN[7]);
  buf B101(WEN_[8], WEN[8]);
  buf B102(WEN_[9], WEN[9]);
  buf B103(WEN_[10], WEN[10]);
  buf B104(WEN_[11], WEN[11]);
  buf B105(WEN_[12], WEN[12]);
  buf B106(WEN_[13], WEN[13]);
  buf B107(WEN_[14], WEN[14]);
  buf B108(WEN_[15], WEN[15]);
  buf B109(WEN_[16], WEN[16]);
  buf B110(WEN_[17], WEN[17]);
  buf B111(WEN_[18], WEN[18]);
  buf B112(WEN_[19], WEN[19]);
  buf B113(WEN_[20], WEN[20]);
  buf B114(WEN_[21], WEN[21]);
  buf B115(WEN_[22], WEN[22]);
  buf B116(WEN_[23], WEN[23]);
  buf B117(WEN_[24], WEN[24]);
  buf B118(WEN_[25], WEN[25]);
  buf B119(WEN_[26], WEN[26]);
  buf B120(WEN_[27], WEN[27]);
  buf B121(WEN_[28], WEN[28]);
  buf B122(WEN_[29], WEN[29]);
  buf B123(WEN_[30], WEN[30]);
  buf B124(WEN_[31], WEN[31]);
  buf B125(WEN_[32], WEN[32]);
  buf B126(WEN_[33], WEN[33]);
  buf B127(WEN_[34], WEN[34]);
  buf B128(WEN_[35], WEN[35]);
  buf B129(A_[0], A[0]);
  buf B130(A_[1], A[1]);
  buf B131(A_[2], A[2]);
  buf B132(A_[3], A[3]);
  ...
  buf B178(D_[34], D[34]);
  buf B179(D_[35], D[35]);
  buf B180(EMA_[0], EMA[0]);
  buf B181(EMA_[1], EMA[1]);
  buf B182(EMA_[2], EMA[2]);
  buf B183(EMAW_[0], EMAW[0]);
  buf B184(EMAW_[1], EMAW[1]);
  buf B185(TEN_, TEN);
  buf B186(TCEN_, TCEN);
  buf B187(TWEN_[0], TWEN[0]);
  buf B188(TWEN_[1], TWEN[1]);
  buf B189(TWEN_[2], TWEN[2]);
  buf B190(TWEN_[3], TWEN[3]);
  buf B191(TWEN_[4], TWEN[4]);
  buf B192(TWEN_[5], TWEN[5]);
  buf B193(TWEN_[6], TWEN[6]);
  buf B194(TWEN_[7], TWEN[7]);
  buf B195(TWEN_[8], TWEN[8]);
  buf B196(TWEN_[9], TWEN[9]);
  buf B197(TWEN_[10], TWEN[10]);
  buf B198(TWEN_[11], TWEN[11]);
  buf B199(TWEN_[12], TWEN[12]);
  buf B200(TWEN_[13], TWEN[13]);
  buf B201(TWEN_[14], TWEN[14]);
  buf B202(TWEN_[15], TWEN[15]);
  buf B203(TWEN_[16], TWEN[16]);
  buf B204(TWEN_[17], TWEN[17]);
  buf B205(TWEN_[18], TWEN[18]);
  buf B206(TWEN_[19], TWEN[19]);
  buf B207(TWEN_[20], TWEN[20]);
  buf B208(TWEN_[21], TWEN[21]);
  buf B209(TWEN_[22], TWEN[22]);
  buf B210(TWEN_[23], TWEN[23]);
  buf B211(TWEN_[24], TWEN[24]);
  buf B212(TWEN_[25], TWEN[25]);
  buf B213(TWEN_[26], TWEN[26]);
  buf B214(TWEN_[27], TWEN[27]);
  buf B215(TWEN_[28], TWEN[28]);
  buf B216(TWEN_[29], TWEN[29]);
  buf B217(TWEN_[30], TWEN[30]);
  buf B218(TWEN_[31], TWEN[31]);
  buf B219(TWEN_[32], TWEN[32]);
  buf B220(TWEN_[33], TWEN[33]);
  buf B221(TWEN_[34], TWEN[34]);
  buf B222(TWEN_[35], TWEN[35]);
  buf B223(TA_[0], TA[0]);
  buf B224(TA_[1], TA[1]);
  buf B225(TA_[2], TA[2]);
  buf B226(TA_[3], TA[3]);
  ...
  buf B231(TA_[8], TA[8]);
  buf B232(TA_[9], TA[9]);
  buf B233(TA_[10], TA[10]);
  buf B234(TA_[11], TA[11]);
  buf B235(TA_[12], TA[12]);
  buf B236(TA_[13], TA[13]);
  buf B237(TA_[14], TA[14]);
  buf B238(TD_[0], TD[0]);
  buf B239(TD_[1], TD[1]);
  buf B240(TD_[2], TD[2]);
  buf B241(TD_[3], TD[3]);
  ...
  buf B246(TD_[8], TD[8]);
  buf B247(TD_[9], TD[9]);
  buf B248(TD_[10], TD[10]);
  buf B249(TD_[11], TD[11]);
  buf B250(TD_[12], TD[12]);
  buf B251(TD_[13], TD[13]);
  buf B252(TD_[14], TD[14]);
  buf B253(TD_[15], TD[15]);
  buf B254(TD_[16], TD[16]);
  buf B255(TD_[17], TD[17]);
  buf B256(TD_[18], TD[18]);
  buf B257(TD_[19], TD[19]);
  buf B258(TD_[20], TD[20]);
  buf B259(TD_[21], TD[21]);
  buf B260(TD_[22], TD[22]);
  buf B261(TD_[23], TD[23]);
  buf B262(TD_[24], TD[24]);
  buf B263(TD_[25], TD[25]);
  buf B264(TD_[26], TD[26]);
  buf B265(TD_[27], TD[27]);
  buf B266(TD_[28], TD[28]);
  buf B267(TD_[29], TD[29]);
  buf B268(TD_[30], TD[30]);
  buf B269(TD_[31], TD[31]);
  buf B270(TD_[32], TD[32]);
  buf B271(TD_[33], TD[33]);
  buf B272(TD_[34], TD[34]);
  buf B273(TD_[35], TD[35]);
  buf B274(GWEN_, GWEN);
  buf B275(TGWEN_, TGWEN);
  buf B276(RET1N_, RET1N);
  buf B277(SI_[0], SI[0]);
  buf B278(SI_[1], SI[1]);
  buf B279(SE_, SE);
  buf B280(DFTRAMBYP_, DFTRAMBYP);

  assign CENY_ = (RET1N_ | pre_charge_st) ? (DFTRAMBYP_ & (TEN_ ? CEN_ : TCEN_)) : 1'bx;
  assign WENY_ = (RET1N_ | pre_charge_st) ? ({36{DFTRAMBYP_}} & (TEN_ ? WEN_ : TWEN_)) : {36{1'bx}};
  ...
  assign Q_ = (RET1N_ | pre_charge_st) ? ((Q_int)) : {36{1'bx}};
  assign SO_ = (RET1N_ | pre_charge_st) ? ({Q_[18], Q_[17]}) : {2{1'bx}};
  ...
  begin
    if (GWEN_int !== 1'b1 && DFTRAMBYP_int=== 1'b0 && SE_int === 1'bx) begin
      ...
      if (GWEN_int !== 1'b1 || DFTRAMBYP_int === 1'b1) begin
        ...
        shifted_readLatch0 = (readLatch0 >> A_int[4:3]);
        Q_int = {shifted_readLatch0[140], shifted_readLatch0[136], shifted_readLatch0[132],
          shifted_readLatch0[128], shifted_readLatch0[124], shifted_readLatch0[120],
          shifted_readLatch0[116], shifted_readLatch0[112], shifted_readLatch0[108],
          shifted_readLatch0[104], shifted_readLatch0[100], shifted_readLatch0[96],
          shifted_readLatch0[92], shifted_readLatch0[88], shifted_readLatch0[84], shifted_readLatch0[80],
...
`endif
    ...
    if ((CLK_ === 1'bx || CLK_ === 1'bz) && RET1N_ !== 1'b0) begin
      ...
      if (DFTRAMBYP_=== 1'b1 && SE_ === 1'b1) begin
         read_mux_sel0 = (TEN_ ? A_[4:3] : TA_[4:3] );
         read_mux_sel0_p2 = ((^read_mux_sel0 === 1'bx) && DFTRAMBYP_p2) ? {2{1'b0}} : read_mux_sel0;
	Q_int[35:18] = {SI_[1], Q_int[35:19]}; 
	Q_int[17:0] = {Q_int[16:0], SI_[0]}; 
      end else begin
      CEN_int = TEN_ ? CEN_ : TCEN_;
      EMA_int = EMA_;
      EMAW_int = EMAW_;
...
`endif
 ...
 wire  CLK_;
  ...
  buf B281(CENY, CENY_);
  buf B282(WENY[0], WENY_[0]);
  buf B283(WENY[1], WENY_[1]);
  buf B284(WENY[2], WENY_[2]);
  buf B285(WENY[3], WENY_[3]);
  buf B286(WENY[4], WENY_[4]);
  buf B287(WENY[5], WENY_[5]);
  buf B288(WENY[6], WENY_[6]);
  buf B289(WENY[7], WENY_[7]);
  buf B290(WENY[8], WENY_[8]);
  buf B291(WENY[9], WENY_[9]);
  buf B292(WENY[10], WENY_[10]);
  buf B293(WENY[11], WENY_[11]);
  buf B294(WENY[12], WENY_[12]);
  buf B295(WENY[13], WENY_[13]);
  buf B296(WENY[14], WENY_[14]);
  buf B297(WENY[15], WENY_[15]);
  buf B298(WENY[16], WENY_[16]);
  buf B299(WENY[17], WENY_[17]);
  buf B300(WENY[18], WENY_[18]);
  buf B301(WENY[19], WENY_[19]);
  buf B302(WENY[20], WENY_[20]);
  buf B303(WENY[21], WENY_[21]);
  buf B304(WENY[22], WENY_[22]);
  buf B305(WENY[23], WENY_[23]);
  buf B306(WENY[24], WENY_[24]);
  buf B307(WENY[25], WENY_[25]);
  buf B308(WENY[26], WENY_[26]);
  buf B309(WENY[27], WENY_[27]);
  buf B310(WENY[28], WENY_[28]);
  buf B311(WENY[29], WENY_[29]);
  buf B312(WENY[30], WENY_[30]);
  buf B313(WENY[31], WENY_[31]);
  buf B314(WENY[32], WENY_[32]);
  buf B315(WENY[33], WENY_[33]);
  buf B316(WENY[34], WENY_[34]);
  buf B317(WENY[35], WENY_[35]);
  buf B318(AY[0], AY_[0]);
  buf B319(AY[1], AY_[1]);
  buf B320(AY[2], AY_[2]);
  buf B321(AY[3], AY_[3]);
  ...
  buf B326(AY[8], AY_[8]);
  buf B327(AY[9], AY_[9]);
  buf B328(AY[10], AY_[10]);
  buf B329(AY[11], AY_[11]);
  buf B330(AY[12], AY_[12]);
  buf B331(AY[13], AY_[13]);
  buf B332(AY[14], AY_[14]);
  buf B333(GWENY, GWENY_);
  buf B334(Q[0], Q_[0]);
  buf B335(Q[1], Q_[1]);
  buf B336(Q[2], Q_[2]);
  buf B337(Q[3], Q_[3]);
  ...
  buf B372(CLK_, CLK);
  buf B373(CEN_, CEN);
  buf B374(WEN_[0], WEN[0]);
  buf B375(WEN_[1], WEN[1]);
  buf B376(WEN_[2], WEN[2]);
  buf B377(WEN_[3], WEN[3]);
  buf B378(WEN_[4], WEN[4]);
  buf B379(WEN_[5], WEN[5]);
  buf B380(WEN_[6], WEN[6]);
  buf B381(WEN_[7], WEN[7]);
  buf B382(WEN_[8], WEN[8]);
  buf B383(WEN_[9], WEN[9]);
  buf B384(WEN_[10], WEN[10]);
  buf B385(WEN_[11], WEN[11]);
  buf B386(WEN_[12], WEN[12]);
  buf B387(WEN_[13], WEN[13]);
  buf B388(WEN_[14], WEN[14]);
  buf B389(WEN_[15], WEN[15]);
  buf B390(WEN_[16], WEN[16]);
  buf B391(WEN_[17], WEN[17]);
  buf B392(WEN_[18], WEN[18]);
  buf B393(WEN_[19], WEN[19]);
  buf B394(WEN_[20], WEN[20]);
  buf B395(WEN_[21], WEN[21]);
  buf B396(WEN_[22], WEN[22]);
  buf B397(WEN_[23], WEN[23]);
  buf B398(WEN_[24], WEN[24]);
  buf B399(WEN_[25], WEN[25]);
  buf B400(WEN_[26], WEN[26]);
  buf B401(WEN_[27], WEN[27]);
  buf B402(WEN_[28], WEN[28]);
  buf B403(WEN_[29], WEN[29]);
  buf B404(WEN_[30], WEN[30]);
  buf B405(WEN_[31], WEN[31]);
  buf B406(WEN_[32], WEN[32]);
  buf B407(WEN_[33], WEN[33]);
  buf B408(WEN_[34], WEN[34]);
  buf B409(WEN_[35], WEN[35]);
  buf B410(A_[0], A[0]);
  buf B411(A_[1], A[1]);
  buf B412(A_[2], A[2]);
  buf B413(A_[3], A[3]);
  ...
  buf B459(D_[34], D[34]);
  buf B460(D_[35], D[35]);
  buf B461(EMA_[0], EMA[0]);
  buf B462(EMA_[1], EMA[1]);
  buf B463(EMA_[2], EMA[2]);
  buf B464(EMAW_[0], EMAW[0]);
  buf B465(EMAW_[1], EMAW[1]);
  buf B466(TEN_, TEN);
  buf B467(TCEN_, TCEN);
  buf B468(TWEN_[0], TWEN[0]);
  buf B469(TWEN_[1], TWEN[1]);
  buf B470(TWEN_[2], TWEN[2]);
  buf B471(TWEN_[3], TWEN[3]);
  buf B472(TWEN_[4], TWEN[4]);
  buf B473(TWEN_[5], TWEN[5]);
  buf B474(TWEN_[6], TWEN[6]);
  buf B475(TWEN_[7], TWEN[7]);
  buf B476(TWEN_[8], TWEN[8]);
  buf B477(TWEN_[9], TWEN[9]);
  buf B478(TWEN_[10], TWEN[10]);
  buf B479(TWEN_[11], TWEN[11]);
  buf B480(TWEN_[12], TWEN[12]);
  buf B481(TWEN_[13], TWEN[13]);
  buf B482(TWEN_[14], TWEN[14]);
  buf B483(TWEN_[15], TWEN[15]);
  buf B484(TWEN_[16], TWEN[16]);
  buf B485(TWEN_[17], TWEN[17]);
  buf B486(TWEN_[18], TWEN[18]);
  buf B487(TWEN_[19], TWEN[19]);
  buf B488(TWEN_[20], TWEN[20]);
  buf B489(TWEN_[21], TWEN[21]);
  buf B490(TWEN_[22], TWEN[22]);
  buf B491(TWEN_[23], TWEN[23]);
  buf B492(TWEN_[24], TWEN[24]);
  buf B493(TWEN_[25], TWEN[25]);
  buf B494(TWEN_[26], TWEN[26]);
  buf B495(TWEN_[27], TWEN[27]);
  buf B496(TWEN_[28], TWEN[28]);
  buf B497(TWEN_[29], TWEN[29]);
  buf B498(TWEN_[30], TWEN[30]);
  buf B499(TWEN_[31], TWEN[31]);
  buf B500(TWEN_[32], TWEN[32]);
  buf B501(TWEN_[33], TWEN[33]);
  buf B502(TWEN_[34], TWEN[34]);
  buf B503(TWEN_[35], TWEN[35]);
  buf B504(TA_[0], TA[0]);
  buf B505(TA_[1], TA[1]);
  buf B506(TA_[2], TA[2]);
  buf B507(TA_[3], TA[3]);
  ...
  buf B512(TA_[8], TA[8]);
  buf B513(TA_[9], TA[9]);
  buf B514(TA_[10], TA[10]);
  buf B515(TA_[11], TA[11]);
  buf B516(TA_[12], TA[12]);
  buf B517(TA_[13], TA[13]);
  buf B518(TA_[14], TA[14]);
  buf B519(TD_[0], TD[0]);
  buf B520(TD_[1], TD[1]);
  buf B521(TD_[2], TD[2]);
  buf B522(TD_[3], TD[3]);
  ...
  buf B527(TD_[8], TD[8]);
  buf B528(TD_[9], TD[9]);
  buf B529(TD_[10], TD[10]);
  buf B530(TD_[11], TD[11]);
  buf B531(TD_[12], TD[12]);
  buf B532(TD_[13], TD[13]);
  buf B533(TD_[14], TD[14]);
  buf B534(TD_[15], TD[15]);
  buf B535(TD_[16], TD[16]);
  buf B536(TD_[17], TD[17]);
  buf B537(TD_[18], TD[18]);
  buf B538(TD_[19], TD[19]);
  buf B539(TD_[20], TD[20]);
  buf B540(TD_[21], TD[21]);
  buf B541(TD_[22], TD[22]);
  buf B542(TD_[23], TD[23]);
  buf B543(TD_[24], TD[24]);
  buf B544(TD_[25], TD[25]);
  buf B545(TD_[26], TD[26]);
  buf B546(TD_[27], TD[27]);
  buf B547(TD_[28], TD[28]);
  buf B548(TD_[29], TD[29]);
  buf B549(TD_[30], TD[30]);
  buf B550(TD_[31], TD[31]);
  buf B551(TD_[32], TD[32]);
  buf B552(TD_[33], TD[33]);
  buf B553(TD_[34], TD[34]);
  buf B554(TD_[35], TD[35]);
  buf B555(GWEN_, GWEN);
  buf B556(TGWEN_, TGWEN);
  buf B557(RET1N_, RET1N);
  buf B558(SI_[0], SI[0]);
  buf B559(SI_[1], SI[1]);
  buf B560(SE_, SE);
  buf B561(DFTRAMBYP_, DFTRAMBYP);
  ...
  assign GWENY_ = (RET1N_ | pre_charge_st) ? (DFTRAMBYP_ & (TEN_ ? GWEN_ : TGWEN_)) : 1'bx;
   `ifdef ARM_FAULT_MODELING
     sramsp32768x36_error_injection u1(.CLK(CLK_), .Q_out(Q_), .A(A_int), .CEN(CEN_int), .DFTRAMBYP(DFTRAMBYP_int), .SE(SE_int), .GWEN(GWEN_int), .WEN(WEN_int), .Q_in(Q_int));
  `else
  assign Q_ = (RET1N_ | pre_charge_st) ? ((Q_int)) : {36{1'bx}};
  `endif
  assign SO_ = (RET1N_ | pre_charge_st) ? ({Q_[18], Q_[17]}) : {2{1'bx}};
...
`endif
`timescale 1ns/1ps
module sramsp32768x36_error_injection (Q_out, Q_in, CLK, A, CEN, DFTRAMBYP, SE, WEN, GWEN);
   output [35:0] Q_out;
   input [35:0] Q_in;
   input CLK;
   input [14:0] A;
   ...
   reg entry_found;
   reg list_complete;
   reg [25:0] fault_table [1023:0];
   reg [25:0] fault_entry;
initial
begin
   `ifdef DUT
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.SMARCHCHKBVCD_LVISION_MBISTPG_ASSEMBLY_UNDER_TEST_INST.MEM0_MEM_INST.u1.add_fault(15'd7295,6'd34,2'd1,2'd0);
   `endif
end
   task add_fault;
