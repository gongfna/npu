...
//----------------------------------------------------------------------
  ...
  wire [NUM_VIS_SP-1:0] ar_bus_valid_r_o_unconn;
  wire ar_issued_wtx_shrd_mst_oh_o;

  wire [NUM_VIS_SP-1:0] aw_bus_valid_r_o_unconn;
  ...
  U_AR_DW_axi_irs_arbpl (
    ...
    // Unconnected outputs.
    .bus_valid_r_o            (ar_bus_valid_r_o_unconn),
  ...
  generate
    if(!REMOVE_R) begin : gen_r_drespch
      //----------------------------------------------------------------
  ...
  U_AW_DW_axi_irs_arbpl (
    ...
    // Unconnected outputs.
    .bus_valid_r_o            (aw_bus_valid_r_o_unconn),
  ...
  generate
    if(!REMOVE_B) begin : gen_b_drespch
      //----------------------------------------------------------------
