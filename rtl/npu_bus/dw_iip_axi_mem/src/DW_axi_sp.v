...
//----------------------------------------------------------------------
  ...
  // Register variables for cross address channel AXI locking
  // communication signals.
  reg [AR_NVM-1:0]      bus_grant_arb_ar_r;     
  reg [AR_NVM_LOG2-1:0] grant_m_local_arb_ar_r;
  reg [AW_NVM-1:0]      bus_grant_arb_aw_r;     
  reg [AW_NVM_LOG2-1:0] grant_m_local_arb_aw_r;
  reg                   arlock_r; 
  reg                   awlock_r; 
  ...
  generate
    if(!REMOVE_AR) begin : gen_ar_addrch
      //----------------------------------------------------------------
  ...
  generate
    if(!REMOVE_AW) begin : gen_aw_addrch
      //----------------------------------------------------------------
  ...
  generate
    if(!REMOVE_W) begin : gen_w_datach
      //----------------------------------------------------------------
