...
`define X2P_START_PADDR_S0 64'h00000000ef000000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define X2P_END_PADDR_S0 64'h00000000ef0007ff
...
`define X2P_AXI_START_ADDR 64'hef000000


`define X2P_AXI_END_ADDR 64'hef0007ff



// Name:         X2P_START_PADDR_32_S0
// Default:      0xef000000 (X2P_START_PADDR_S0 & 0x00000000ffffffff)
...
`define X2P_START_PADDR_32_S0 32'hef000000


// Name:         X2P_END_PADDR_32_S0
// Default:      0xef0007ff (X2P_END_PADDR_S0 & 0x00000000ffffffff)
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define X2P_END_PADDR_32_S0 32'hef0007ff
