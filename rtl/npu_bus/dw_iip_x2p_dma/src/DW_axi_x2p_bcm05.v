...
// Description : DW_axi_x2p_bcm05.v Verilog module for DWbb
//
...
reg [COUNT_WIDTH-1 : 0]               this_addr_g_ltch;
  ...
  // out, back to the pop input. In the case of the X2P, this can happen
