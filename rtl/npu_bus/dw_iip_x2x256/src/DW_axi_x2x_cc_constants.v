...
`define X2X_SP_DW 256



// Name:         X2X_SP_SW
// Default:      32 (X2X_SP_DW/8)
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Default:      32 ( [ <functionof> X2X_SP_DW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Maximum possible number of bytes in X2X_SP_DW.
`define X2X_MAX_SP_BYTES 32
...
// Default:      5 ( [ <functionof> X2X_MAX_SP_BYTES ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Log base 2 of maximum possible number of bytes in X2X_SP_DW.
`define X2X_LOG2_MAX_SP_BYTES 5
...
// 
// Log base 2 of maximum possible number of bytes in X2X_SP_DW.
`define X2X_0LOG2_MAX_SP_BYTES 5
...
// Default:      512 (X2X_MAX_SP_BYTES*(X2X_MAX_SP_ALEN+1))
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Maximum possible total transfer size in bytes on the X2X SP.
`define X2X_MAX_SP_TOTAL_BYTE 512
...
// Default:      9 ([ <functionof> X2X_MAX_SP_TOTAL_BYTE ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_LOG2_MAX_SP_TOTAL_BYTE: 
// This is the log2 of (X2X_MAX_SP_TOTAL_BYTE)
`define X2X_LOG2_SP_BYTE 9
...
// Name:         X2X_LOG2_SP_SW
// Default:      5 ( [ <functionof> X2X_SP_SW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Log base 2 of X2X_SP_SW
`define X2X_LOG2_SP_SW 5



// Name:         X2X_ADDR_TRK_W
// Default:      5 ( [ <functionof> X2X_MP_SW X2X_SP_SW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_ADDR_TRK_W 
...
// Default:      17 ( [ <functionof> X2X_TX_ALTER X2X_HAS_ET X2X_SP_BLW 
