...
// Default:      4 ( [ <functionof> X2X_SP_DW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Maximum possible number of bytes in X2X_SP_DW.
`define X2X_MAX_SP_BYTES 4
...
// Default:      2 ( [ <functionof> X2X_MAX_SP_BYTES ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Log base 2 of maximum possible number of bytes in X2X_SP_DW.
`define X2X_LOG2_MAX_SP_BYTES 2
...
// 
// Log base 2 of maximum possible number of bytes in X2X_SP_DW.
`define X2X_0LOG2_MAX_SP_BYTES 2
...
// Default:      64 (X2X_MAX_SP_BYTES*(X2X_MAX_SP_ALEN+1))
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Maximum possible total transfer size in bytes on the X2X SP.
`define X2X_MAX_SP_TOTAL_BYTE 64
...
// Default:      6 ([ <functionof> X2X_MAX_SP_TOTAL_BYTE ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_LOG2_MAX_SP_TOTAL_BYTE: 
// This is the log2 of (X2X_MAX_SP_TOTAL_BYTE)
`define X2X_LOG2_SP_BYTE 6



// Name:         X2X_WIP_FIFO_D
// Default:      5 ( [ <functionof> X2X_MAX_MP_TOTAL_BYTE X2X_MAX_SP_TOTAL_BYTE 
//               X2X_HAS_WRAP_BURST ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// configurations. 
// Max value is 64
`define X2X_WIP_FIFO_D 5



// Name:         X2X_LOG2_WIP_FIFO_D
// Default:      3 ([ <functionof> X2X_WIP_FIFO_D ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// This is the log2 of (X2X_WIP_FIFO_D)
`define X2X_LOG2_WIP_FIFO_D 3
...
// Name:         X2X_LOG2_SP_SW
// Default:      2 ( [ <functionof> X2X_SP_SW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// Log base 2 of X2X_SP_SW
`define X2X_LOG2_SP_SW 2
...
// Default:      3 ( [ <functionof> X2X_MP_DW X2X_SP_DW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
`define X2X_SP_W_BEATS_PER_POP_W 3
...
// Name:         X2X_DATA_SEL_W
// Default:      2 ( [ <functionof> X2X_MP_SW X2X_SP_SW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_DATA_SEL_W 
...
// Name:         X2X_RS_RATIO
// Default:      4 ( [ <functionof> X2X_MP_DW X2X_SP_DW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_RS_RATIO 
// Resizing ratio within the X2X.
`define X2X_RS_RATIO 4
