...
// Name:         X2X_WRAP_BURST
// Default:      0 (X2X_HAS_WRAP_BURST == 1 ? 1 : 0)
// Values:       0, 1
// Enabled:      0
// 
...
// Default:      8 ( [ <functionof> X2X_SP_DW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Default:      3 ( [ <functionof> X2X_MAX_SP_BYTES ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Default:      128 (X2X_MAX_SP_BYTES*(X2X_MAX_SP_ALEN+1))
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Default:      7 ([ <functionof> X2X_MAX_SP_TOTAL_BYTE ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Name:         X2X_WIP_FIFO_D
// Default:      2 ( [ <functionof> X2X_MAX_MP_TOTAL_BYTE X2X_MAX_SP_TOTAL_BYTE 
//               X2X_HAS_WRAP_BURST ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Default:      1 ( [ <functionof> X2X_AW_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_AW_BUF_DEPTH_L2 
// Log base 2 of X2X_AW_BUF_DEPTH
`define X2X_AW_BUF_DEPTH_L2 1
...
`define X2X_AW_BUF_DEPTH_P1L2 2



// Name:         X2X_W_BUF_DEPTH_L2
// Default:      1 ( [ <functionof> X2X_W_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_W_BUF_DEPTH_L2 
// Log base 2 of X2X_W_BUF_DEPTH
`define X2X_W_BUF_DEPTH_L2 1



// Name:         X2X_W_BUF_DEPTH_P1L2
// Default:      2 ( [ <functionof> X2X_W_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_W_BUF_DEPTH_P1L2 
// Log base 2 of (X2X_W_BUF_DEPTH+1)
`define X2X_W_BUF_DEPTH_P1L2 2



// Name:         X2X_B_BUF_DEPTH_L2
// Default:      4 ( [ <functionof> X2X_B_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_B_BUF_DEPTH_L2 
// Log base 2 of X2X_B_BUF_DEPTH
`define X2X_B_BUF_DEPTH_L2 4



// Name:         X2X_B_BUF_DEPTH_P1L2
// Default:      5 ( [ <functionof> X2X_B_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_B_BUF_DEPTH_P1L2 
// Log base 2 of (X2X_B_BUF_DEPTH+1)
`define X2X_B_BUF_DEPTH_P1L2 5



// Name:         X2X_AR_BUF_DEPTH_L2
// Default:      1 ( [ <functionof> X2X_AR_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_AR_BUF_DEPTH_L2 
// Log base 2 of X2X_AR_BUF_DEPTH
`define X2X_AR_BUF_DEPTH_L2 1
...
`define X2X_AR_BUF_DEPTH_P1L2 2



// Name:         X2X_R_BUF_DEPTH_L2
// Default:      1 ( [ <functionof> X2X_R_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_R_BUF_DEPTH_L2 
// Log base 2 of X2X_R_BUF_DEPTH
`define X2X_R_BUF_DEPTH_L2 1



// Name:         X2X_R_BUF_DEPTH_P1L2
// Default:      2 ( [ <functionof> X2X_R_BUF_DEPTH ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_R_BUF_DEPTH_P1L2 
// Log base 2 of (X2X_R_BUF_DEPTH+1)
`define X2X_R_BUF_DEPTH_P1L2 2
...
// Name:         X2X_LOG2_SP_SW
// Default:      3 ( [ <functionof> X2X_SP_SW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
// Name:         X2X_ADDR_TRK_W
// Default:      4 ( [ <functionof> X2X_MP_SW X2X_SP_SW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
// X2X_ADDR_TRK_W 
...
`define X2X_ADDR_TRK_W 4



// Name:         X2X_TX_ALTER
// Default:      2 ( [ <functionof> X2X_MP_DW X2X_SP_DW X2X_MP_BLW X2X_SP_BLW 
//               X2X_HAS_TX_UPSIZE])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
`define X2X_TX_ALTER 2



// Name:         X2X_HAS_TX_NO_ALTER
// Default:      0 ((X2X_TX_ALTER == 0) ? 1 : 0)
// Values:       0, 1
// Enabled:      0
// 
// X2X_HAS_TX_NO_ALTER 
...
// Default:      2 ( [ <functionof> X2X_MP_DW X2X_SP_DW ])
// Values:       -2147483648, ..., 2147483647
// Enabled:      0
// 
...
`define X2X_SP_W_BEATS_PER_POP_W 2



// Name:         X2X_SP_W_RSFIFO_W
// Default:      16 ( [ <functionof> X2X_TX_ALTER X2X_HAS_ET X2X_SP_BLW 
...
// Default:      1 (X2X_MP_DW > X2X_SP_DW ? 1 : 0)
// Values:       0, 1
// Enabled:      0
// 
