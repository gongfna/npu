...
// Description : DW_axi_x2x_bcm57.v Verilog module for DWbb
//
...
// clock domain
// rd_addr_pipe is async path from pop clock if this is used in a dual
// clock fifo. But MEM_MODE==0 in that case, so rd_addr_pipe is not used.
// leda NTL_CLK05 off
