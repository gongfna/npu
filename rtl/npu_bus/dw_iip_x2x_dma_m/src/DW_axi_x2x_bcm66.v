...
parameter DEPTH = 8;		// RANGE 4 to 256
parameter ADDR_WIDTH = 3;	// RANGE 2 to 8
parameter COUNT_WIDTH = 4;	// RANGE 3 to 9
parameter PUSH_AE_LVL = 2;	// RANGE 1 to 255
parameter PUSH_AF_LVL = 2;	// RANGE 1 to 255
parameter POP_AE_LVL = 2;	// RANGE 1 to 255
parameter POP_AF_LVL = 2;	// RANGE 1 to 255
