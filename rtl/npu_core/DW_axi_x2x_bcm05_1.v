...
module bm_cpub_axi2top_DW_axi_x2x_bcm05_1(
	clk,
	rst_n,
	init_n,
	inc_req_n,
...
output [ADDR_WIDTH-1 : 0]	      last_addr;	// Local RAM address
...
reg [COUNT_WIDTH-1 : 0]               this_addr_g_ltch;
  ...
  assign this_addr          = ((1<<COUNT_WIDTH) != (DEPTH*2)) ?
                              this_addr_int :
                              count;
  assign last_addr          = next_count_int;
  ...
  bm_cpub_axi2top_DW_axi_x2x_bcm21
